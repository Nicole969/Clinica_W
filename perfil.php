                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <a href="editar_perfil.php?id=<?php echo $perfil['ID_Perfil']; ?>"
                                    class="bg-yellow-500 text-white py-1 px-2 rounded hover:bg-yellow-600">Editar</a>
                                <a href="eliminar_perfil.php?id=<?php echo $perfil['ID_Perfil']; ?>"
                                    class="bg-red-500 text-white py-1 px-2 rounded hover:bg-red-600"
                                    onclick="return confirm('¿Estás seguro de eliminar este perfil médico?');">Eliminar</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
